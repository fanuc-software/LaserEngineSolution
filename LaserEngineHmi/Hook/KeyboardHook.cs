        ...
        public class KeyboardHook
        {
            ...
            public void Start()
            {
                ...
                if (hKeyboardHook == 0)
                {
                    ...
                    hKeyboardHook = SetWindowsHookEx(WH_KEYBOARD_LL, KeyboardHookProcedure, GetModuleHandle(System.Diagnostics.Process.GetCurrentProcess().ProcessName), 0);
            ...
            private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
            {
                ...
                if ((nCode >= 0) && (KeyDownEvent != null || KeyUpEvent != null || KeyPressEvent != null))
                {
                    ...
                    if (KeyDownEvent != null && (wParam == WM_KEYDOWN || wParam == WM_SYSKEYDOWN))
                    {
                        ...
                        //using (System.IO.StreamWriter sw = new System.IO.StreamWriter("d:\\ccc.txt", true))
                        //{
                        //    sw.WriteLine(
                        //        MyKeyboardHookStruct.vkCode.ToString() + "      " +
                        //        MyKeyboardHookStruct.scanCode.ToString() + "      " +
                        //        e.Modifiers.ToString()+"      "+
                        //        MyKeyboardHookStruct.flags.ToString()
                        //        );
                        //}
                    ...
                    if (KeyPressEvent != null && wParam == WM_KEYDOWN)
                    {
                        ...
                        MyKeyboardHookStruct.flags) == 1)
                        {
                            ...
                            //KeyPressEventArgs e = new KeyPressEventArgs((char)MyKeyboardHookStruct.vkCode);
                            //using (System.IO.StreamWriter sw = new System.IO.StreamWriter("d:\\aaa.txt", true))
                            //{
                            //    sw.WriteLine(e.KeyChar.ToString());
                            //}
